...
Status: primary pre-read for Jarvis-PLOT changes.
...
2. `docs/context/JARVIS_PLOT_FRAMEWORK_LOGIC.md`
3. `docs/design/ARCHITECTURE_OVERVIEW.md`
4. `docs/design/LAYOUT_ENGINE_DESIGN.md`
5. `docs/design/STYLE_SYSTEM_DESIGN.md`
6. `docs/specs/SCENE_JSON_SCHEMA.md`
...
- module entry point: `python -m jarvisplot`
...
- input surfaces: YAML figure configs, style cards, dataset configs, scene-oriented JSON
...
4. `jarvisplot/Figure/preprocessor.py` prepares transform and profile pipelines
5. `jarvisplot/Figure/figure.py` builds axes and scene state for each figure
6. `jarvisplot/Figure/method_registry.py` resolves draw methods
7. `jarvisplot/Figure/adapters.py` executes backend-specific drawing
8. output is written through figure save/render paths

## 6. Flowchart Migration Context
